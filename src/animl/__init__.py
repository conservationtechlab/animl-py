...
from animl.reid import (ArcFaceLossAdaptiveMargin, ArcFaceSubCenterDynamic,
                        ...
                        ImageGenerator, MiewIdNet, ViewpointModel, dataloader,
                        generator, heads, l2_norm, load, loadable_path, miewid,
                        predict, viewpoint, weights_init_classifier,
...
from animl.utils import (AUTOINSTALL, Albumentations, BAR_FORMAT, CONFIG_DIR,
                         ...
                         notebook_init, one_cycle, print_args, print_mutation,
...
__all__ = ['AUTOINSTALL', 'Albumentations', 'ArcFaceLossAdaptiveMargin',
           ...
           'MiewIdNet', 'Model', 'ModelEMA', 'NCOLS', 'NUM_THREADS', 'Profile',
           'RANK', 'ROOT', 'ResizeWithPadding', 'SPP', 'SPPF', 'Timeout',
           'TrainGenerator', 'TransformerBlock', 'TransformerLayer', 'VERBOSE',
           'VID_FORMATS', 'ViewpointModel', 'WorkingDirectory', 'active_times',
           ...
           'dataloader', 'dataloaders', 'dataset_stats', 'de_parallel',
           'demo_boxes', 'detect', 'detect_MD_batch',
           ...
           'general', 'generator', 'get_animals', 'get_empty', 'get_hash',
           ...
           'non_max_suppression', 'notebook_init', 'one_cycle', 'parse_MD',
           'parse_model', 'plot_all_bounding_boxes', 'plot_boxes', 'predict',
           'predict_species', 'print_args', 'print_mutation', 'process_image',
           'profile', 'prune', 'random_perspective', 'reid', 'remove_symlink',
           'replicate', 'resample_segments', 'resize_with_padding',
