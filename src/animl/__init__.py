...
from animl.utils import (MD_COLORS, NUM_THREADS, animlr, check_exiftool,
                         check_onnx_cuda, check_torch_cuda, general, get_iou,
...
__all__ = ['BIOCLIP_CLASSIFIER_SIZE', 'BioCLIP', 'Bottleneck', 'C3',
           ...
           'model_architecture', 'models', 'parse_detections', 'pipeline',
           'plot_all_bounding_boxes', 'plot_box', 'pose', 'predict_viewpoints',
           'reid', 'remove_diagonal', 'remove_link', 'save_classifier',
           'save_data', 'save_json', 'save_yaml', 'sequence_calculation',
           'sequence_classification', 'single_classification', 'test',
