...
__all__ = ['AUTOINSTALL', 'Albumentations', 'ArcFaceLossAdaptiveMargin',
           ...
           'VERBOSE', 'VID_FORMATS', 'ViewpointModel', 'WorkingDirectory',
           'absolute2relative', 'active_times', 'animl_results_to_md_results',
           'animl_to_md', 'api', 'apply_classifier', 'augment_hsv',
           'augmentations', 'autopad', 'autosplit', 'bbox_iou', 'box_area',
           'box_candidates', 'box_iou', 'build_file_manifest', 'check_amp',
           'check_anchor_order', 'check_dataset', 'check_file', 'check_font',
           ...
           'classify_mp', 'classify_with_config', 'clean_str', 'clip_coords',
           'coco80_to_coco91_class', 'colorstr', 'common',
           'convert_yolo_to_xywh', 'copy_attr', 'copy_paste',
           ...
           'set_logging', 'softmax', 'sort_MD', 'sort_species', 'sparsity',
           'species', 'split', 'strip_optimizer', 'tensor_to_onnx', 'test',
