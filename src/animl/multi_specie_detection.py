...
def multi_specie_detection(animals, threshold):
    ...
    animals['FileName'] = animals['FileName'].astype(str)
    animals = animals.sort_values(by="FileName")
    ...
    for index, row in animals.iterrows():
        ...
        elif row['FileName'] == curr_picture[0]['FileName']:
            curr_picture.append(row)
