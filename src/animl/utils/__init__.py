...
from animl.utils.general import (NUM_THREADS, box_area, box_iou,
                                 ...
                                 copy_attr, de_parallel, device_count,
                                 exif_transpose, file_age, file_date,
                                 file_size, find_modules, fitness,
                                 fuse_conv_and_bn, get_device, get_latest_run,
                                 ...
                                 profile, prune, resample_segments,
                                 scale_coords, scale_img, segment2box,
                                 segments2boxes, select_device, softmax,
                                 sparsity, strip_optimizer, tensor_to_onnx,
                                 time_sync, xyn2xy, xywh2xyxy, xywhn2xyxy,
...
__all__ = ['FILE', 'NUM_THREADS', 'RANK', 'ROOT', 'autopad', 'box_area',
           ...
           'tensor_to_onnx', 'time_sync', 'xyn2xy', 'xywh2xyxy', 'xywhn2xyxy',
           'xyxy2xywh', 'xyxy2xywhn', 'yolo5']
